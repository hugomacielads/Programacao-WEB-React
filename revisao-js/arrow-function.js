...
// 4) Após o parâmetro, aparece o simbolo => (flecha, arrow)
...
// Função tradicional com 2 argumento, 1 linha de corpo com return
...
// precisa ter uma condição de saída
//const fat = (num) => num * fat(num -1)
...
const horaAtual12 = () => new Date()

console.log(horaAtual().toLocaleString('pt-BR', {timeZone: 'America/Sao_Paulo'}))
console.log(horaAtual12().toLocaleString('pt-BR', {timeZone: 'America/Sao_Paulo'}))
